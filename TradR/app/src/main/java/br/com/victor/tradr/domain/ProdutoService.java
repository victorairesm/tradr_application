...
public class ProdutoService {
    ...
    public static List<Produto> getProdutosByCategoria(Context context, String categoria) throws IOException {
        String url = categoria != null ? URL_BASE + "/categoria/" + categoria : URL_BASE;
    ...
    public static Response saveProduto(Context context, Produto produto) throws IOException {
        String url = URL_BASE;

        String jsonCarro = new Gson().toJson(produto);
        Log.d(TAG, ">> saveProduto: " + jsonCarro);
        HttpHelper http = new HttpHelper();
        http.setContentType("application/json; charset=utf-8");
        String json = http.doPost(url, jsonCarro.getBytes(), "UTF-8");
        Log.d(TAG, "<< saveProduto: " + json);
...
/*    public static boolean deleteFromDb(Context context, List<Produto> selectedCarros) {
    ...
    // Retorna os produtos favoritados
