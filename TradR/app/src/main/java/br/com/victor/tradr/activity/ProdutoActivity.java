...
public class ProdutoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            BaseFragment frag = editMode ? new ProdutoEditFragment() : new ProdutosFragment();
    ...
    public void toogleFavorite(boolean b) {
        ...
        if (b) {
            snack(appBarImg, produto.getNome() + " adicionado aos favoritos.");
        } else {
            snack(appBarImg, produto.getNome() + " removido dos favoritos.");
        }
    }
